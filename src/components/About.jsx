    ...
    <>
      <div>
        ...
        <div class="flex justify-center items-center ">
          <div class="bg-gray-200 p-4 text-lg mt-6 font-semibold shadow-xl">No Stress, Just Joy!</div>
        </div>

        <div class="flex justify-center items-center ">
          <div class="bg-gray-200 p-4 text-lg font-semibold shadow-xl mx-8 mt-6">“Love your life, perfect your life and beautify all things in your life"</div>
        </div>
